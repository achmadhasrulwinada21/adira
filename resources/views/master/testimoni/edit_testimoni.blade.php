...
<div class="container">
    ...
    <div class="row">
        <div class="col-md-8">
            <div class="card">
                <div class="card-body">
                       <form method="post" action="/testimoni/update/{{ $testimoni->id }}" enctype="multipart/form-data">
                        {{ csrf_field() }}
                        {{ method_field('PUT') }}
         ...
         <div class="col-md-4">
            <div class="card">
                ...
                <option value="1" {{ $testimoni->status == 1 ? 'selected="selected"' : '' }}>Aktif</option>
                <option value="0" {{ $testimoni->status == 0 ? 'selected="selected"' : '' }}>Tidak Aktif</option>
                </select>
            </div>
             <div class="form-group">
